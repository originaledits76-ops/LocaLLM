...
export const AVAILABLE_MODELS: ModelInfo[] = [
  {
    ...
    parameterCount: '135M',
    quantization: '2-Bit (q2_k / q2 WASM & WebGPU)',
    bitPrecision: '2-bit',
    downloadSizeMB: 48,
    minRamGB: 1,
    recommendedRamGB: 2,
    ...
    contextLength: 2048,
    license: 'Apache-2.0',
    creator: 'Hugging Face / ONNX Community',
  ...
  },
  {
    ...
    parameterCount: '135M',
    quantization: '3-Bit (q3_k_m / q3 WASM & WebGPU)',
    bitPrecision: '3-bit',
    downloadSizeMB: 75,
    minRamGB: 1,
    recommendedRamGB: 2,
  ...
  },
  {
    ...
    parameterCount: '0.5B',
    quantization: '3-Bit (q3_k / q3 WASM & WebGPU)',
    bitPrecision: '3-bit',
    downloadSizeMB: 180,
    minRamGB: 2,
    recommendedRamGB: 4,
    ...
    contextLength: 4096,
    license: 'Apache-2.0',
    creator: 'Alibaba Cloud / ONNX Community',
    recommendedTiers: ['entry', 'balanced', 'high'],
    preferredBackend: 'auto',
    dtype: 'q3',
    engineType: 'transformers',
